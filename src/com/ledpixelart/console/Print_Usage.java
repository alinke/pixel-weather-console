...
public class Print_Usage {
	...
	System.out.println("*** PIXEL: Console V3.2 *** \n"
			+ "Usage:"
			+ "pixelc <options>"
			+"Valid options are:\nGIF MODE\n"
			...
			+ "\n--superpixel  change LED matrix to SUPER PIXEL 64x64 V1"
			+ "\n--adafruit32x32  change LED matrix to Adafruit's 32x32 LED matrix or 1/16 scan other 32x32 panels (default if no panel specificed)"
			+ "\n--adafruit32x32colorswap  change LED matrix to 32x32 LED matrix color swap (use if colors are swapped)"
			+ "\n--random32x32  change LED matrix to 32x32 LED matrix, worth a try if pixel ordering is off"
			+ "\n--adafruit32x16  change LED matrix to Adafruit 32x16 LED matrix"
			+ "\n--adafruit64x16  change LED matrix to 64x16 which is two daisy chained 32x16s"
			+ "\n--adafruit64x32  change LED matrix to Adafruit 64x32"
			+ "\n--adafruit64x32colorswap  change LED matrix to Adafruit 64x32 color swap (use if colors are swapped)"
			+ "\n--adafruit64x64  change LED matrix to Adafruit 64x64"
			+ "\n--adafruit64x64colorswap  change LED matrix to Adafruit 64x64 (use if colors are swapped)"
			+ "\n--adafruit128x16 change LED matrix to Adafruit 128x16 which is 4 daisy chained 32x16s (not tested)"
			+ "\n--adafruit256x16 change LED matrix to Adafruit 256x16 which is 8 daisy chained 32x16s (not tested)"
			+ "\n--adafruit32x32m  change LED matrix to 2 Mirrored Adafruit 32x32s (displays the same animation on 2 32x32 panels)"
			+ "\n--adafruit32x324m  change LED matrix to 4 Mirrored Adafruit 32x32s (displays the same animation on 4 32x32 panels)"
			+ "\n--adafruit64x32m  change LED matrix to 2 Mirrored Adafruit 64x32s (displays the same animation on 2 64x32 panels)"
